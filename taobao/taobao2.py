...
lvl2_ignore_image_dir_name = '2_no_img'
...
def main():
    ...
    no_file_path_list = []
    handleimage.list_dir_files(no_file_path_list, image_parent_dir, lvl2_ignore_image_dir_name, pic_ext_name)
    ...
    while True:
        # 识别出最终要点击的坐标
        ignore_img_pos_list = []
        lists = handleimage.match_img2(click_images_list, ignore_images_list, ignore_img_pos_list)
        print("match_img return lists begin")
        print(lists)
        print("match_img return lists end")

        print("ignore_img_pos_list begin")
        print(ignore_img_pos_list)
        print("ignore_img_pos_list end")
